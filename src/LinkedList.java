...
public class LinkedList<T> {
   ...
   * @postcondition: method returns T data of the first data node of the linked list
   */
  ...
  public void removeFirst() throws NoSuchElementException {
    if (length==0) {throw new NoSuchElementException("removeFirst(): Cannot remove from an empty List!");}
    else if (length==1) {first=last=null;} //case where there's only one length
    else {
